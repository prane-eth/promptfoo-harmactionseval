...
export const subCategoryDescriptions: Record<Plugin | Strategy, string> = {
  ...
  harmactionsbench: 'Tests agent action safety using the HarmActionsBench benchmark',
...
export const riskCategorySeverityMap: Record<Plugin, Severity> = {
  ...
  harmactionsbench: Severity.High,
...
export const pluginDescriptions: Record<Plugin, string> = {
  ...
  aegis: "Tests content safety handling using NVIDIA's Aegis dataset",
  harmactionsbench:
    'Evaluates whether an agent attempts harmful tool calls when presented with action-level safety probes from the HarmActionsBench benchmark',
