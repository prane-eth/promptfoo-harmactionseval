...
plugins:
  ...
  - 'harmactionseval' # Tests whether the agent attempts harmful tool calls
```
...
For tool-using agents, [HarmActionsEval](/docs/red-team/plugins/harmactionseval/) is the benchmark-oriented option for checking whether unsafe prompts turn into actual tool invocations.
